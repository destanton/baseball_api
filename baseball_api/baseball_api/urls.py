...
from baseball_data.views import MasterListCreateAPIView, BattingListCreateAPIView, FieldingListCreateAPIView,\
                                PitchingListCreateAPIView, MasterDetailUpdateDestroyAPIView, BattingDetailUpdateDestroyAPIView,\
                                FieldingDetailUpdateDestroyAPIView, PitchingDetailUpdateDestroyAPIView
...
#
# localhost:8000/api/:resource_name/:pk/
